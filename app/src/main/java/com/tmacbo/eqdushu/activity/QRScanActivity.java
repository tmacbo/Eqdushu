...
import com.tmacbo.eqdushu.utils.qrcode.decoding.RGBLuminanceSource;
 ...
 * @Description 二维码扫描页面
 */
public class QRScanActivity extends AppCompatActivity implements Callback, View.OnClickListener {
...
//        initHeadBlue();
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (result == null || result.getText().equals("")) {
            Toast.makeText(this, getResources().getString(R.string.tips_decode_null), Toast.LENGTH_SHORT).show();
        } else {
